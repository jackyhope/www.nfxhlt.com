...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<tr>
			...
			<td align="center"><input type="text" name="order_<?php echo $t['catid']; ?>" class="input-text" style="width:35px;text-align:center" value="<?php echo $t['listorder']; ?>"></td>
		...
		<tr>
			<td colspan="10" align="left">
				<input <?php if (!admin_auth($userinfo['roleid'], 'category-del')) { ?>disabled<?php } ?> type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-del'); ?>" name="delete" onclick="return confirm_del()" />&nbsp;
				<input <?php if (!admin_auth($userinfo['roleid'], 'category-edit')) { ?>disabled<?php } ?> type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-order'); ?>" name="submit" onClick="$('#load').show()" />&nbsp;<div class="onShow"><?php echo lang('a-cat-24'); ?></div>
