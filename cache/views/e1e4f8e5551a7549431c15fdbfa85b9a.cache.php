...
<div class="subnav">
	...
	<div class="explain-col">
		...
		<?php echo lang('a-att-30'); ?>： <input type="text" class="input-text" size="40" name="kw"><input type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-search'); ?>" name="submit">
		</form>
	</div>
	<div class="bk10"></div>
