				...
				<tr>
					...
					<div class="uploadlay"> 
						...
						<div id="ui-upload-button"> 
							<input type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-upload'); ?>" name="submit" align="absmiddle" <?php if ($isimage) { ?>onClick="this.value='uploading'"<?php } else { ?>onClick="uploading()"<?php } ?> />
						</div>
					</div> 
					<script> 
