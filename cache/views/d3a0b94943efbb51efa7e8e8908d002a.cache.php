...
<div class="col-2 lf mr10" style="width:48%">
	...
	<tr>
		...
		<td width="25%" align="center"><a href="<?php echo url('admin/content/',array('catid'=>2,'modelid'=>1)); ?>"><img width="40" height="40" src="<?php echo ADMIN_THEME; ?>images/m1.png"></a></td>
	...
	<tr>
		...
		<td height="33" align="center"><a href="<?php echo url('admin/content/',array('catid'=>2,'modelid'=>1)); ?>">内容管理</a></td>
...
<div class="col-2 col-auto">
	...
	<div class="content" style="height:170px;">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="2"><?php echo lang('a-ind-10'); ?>：&nbsp;<?php echo CMS_NAME; ?>&nbsp;<?php echo CMS_VERSION; ?> </td>
            </tr>
            <tr>
        ...
        <table border="0">
            <tr>
                <td width="60">
                    <img src="<?php echo ADMIN_THEME; ?>images/wx.jpg" width="55" height="55">
                </td>
                <td>
                    <p>用微信扫描二维码，关注“遥阳科技” </p>
                    <p>获取遥阳科技最新研发动态！ </p>
                </td>
            </tr>
        </table>
