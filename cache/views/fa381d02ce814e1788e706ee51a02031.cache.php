        ...
        <?php include $this->_include('column'); ?>
            ...
            <div class="nfb7">
                ...
                <div class="nfb7-f">
                	<div class="nfb7-f1">
                    	<p><font>重庆总部：</font></p>
                        <p><i><img src="<?php echo SITE_THEME; ?>images/lxw1.png" /></i><span>全国服务电话：<!--服务热线--><?php echo block(7); ?><!--服务热线--></span></p>
                        <p><i><img src="<?php echo SITE_THEME; ?>images/lxw2.png" /></i><span><!--总部地址--><?php echo block(10); ?><!--总部地址--></span></p>
                    </div>
                    <div class="nfb7-f2">
						...
						<div class="m_map" style="transform: scale(0.4,0.4)-ms-transform: scale(0.4,0.4);-webkit-transform: scale(0.4,0.4);margin-left:-95%;margin-top:-60%;">
						<style>
							.feng span{font-size:1.8rem !important;}
							.feng p{font-size:1.8rem !important;}
						</style>
							<!--
							<div class="mp mp1">
								<div class="feng">
