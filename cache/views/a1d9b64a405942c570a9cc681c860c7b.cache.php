...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<?php } } ?>
		<tr>
			<td colspan="6" align="left"><input <?php if (!admin_auth($userinfo['roleid'], 'site-del')) { ?>disabled<?php } ?> type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-del'); ?>" name="submit" onclick="return confirm_del()" /></td>
		</tr>
		</tbody>
		</table>
		</form>
