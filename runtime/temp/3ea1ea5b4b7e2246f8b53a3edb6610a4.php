<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/content/dibu.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534843390;s:69:"/home/wwwroot/www.nfxhlt.com/application/admin/view/content/menu.html";i:1534243447;}*/ ?>
...
<div class="pageheader notab">
    <if condition='#'>
        ...
        <else/>
        <h1 class="pagetitle">底部文字 <small><a href="admin/content/edit?ac=newsqiye"></a></small></h1>
    </if>
</div>
        ...
        <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td class="gai"><input class="textbtn"  type="text" style="border:none;width: " readonly="readonly" value="<?php echo $vo['titlecontent']; ?>"></td>
                    <td width="200">
