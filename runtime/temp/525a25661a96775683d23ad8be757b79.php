<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/content/newsqiye.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534843390;s:69:"/home/wwwroot/www.nfxhlt.com/application/admin/view/content/menu.html";i:1534243447;}*/ ?>
...
<div class="pageheader notab">
        <h1 class="pagetitle">企业新闻 <small><a href="admin/content/edit?ac=newsqiye">添加新闻</a></small></h1>
</div>
        ...
        <tbody>
            <?php if(is_array($cnews) || $cnews instanceof \think\Collection || $cnews instanceof \think\Paginator): $i = 0; $__LIST__ = $cnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td width="200">
                        <a href="admin/content/edit?ac=newsqiye&bc=gai&id=<?php echo $vo['Id']; ?>" class="btn btn-xs  btn-primary">查看/修改内容</a>
