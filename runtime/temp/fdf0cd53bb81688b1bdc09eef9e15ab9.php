<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/content/chengnuo.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534843390;s:69:"/home/wwwroot/www.nfxhlt.com/application/admin/view/content/menu.html";i:1534243447;}*/ ?>
        ...
        <tbody>
            <?php if(is_array($title) || $title instanceof \think\Collection || $title instanceof \think\Paginator): $i = 0; $__LIST__ = $title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td  style="text-align: left" class="gai"><input class="textbtn"  type="text" style="border:none" readonly="readonly" value="<?php echo $vo['subname']; ?>"></td>
