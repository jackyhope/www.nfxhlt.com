<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/login/reset.html";i:1534839891;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<div class="loginbox">
    <div class="loginboxinner">
        ...
        <form id="login" action="admin/login/modifypass" method="post">
            <div class="password">
