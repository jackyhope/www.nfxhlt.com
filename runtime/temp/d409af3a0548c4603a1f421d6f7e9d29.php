<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/content/newshangye.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534843390;s:69:"/home/wwwroot/www.nfxhlt.com/application/admin/view/content/menu.html";i:1534243447;}*/ ?>
...
<div class="pageheader notab">
    <if condition='#'>
        ...
        <else/>
        <h1 class="pagetitle">行业资讯 <small><a href="admin/content/edit?ac=newshangye">添加资讯</a></small></h1>
    </if>
</div>
...
<div id="contentwrapper" class="contentwrapper">
    ...
    <table class="table table-striped table-bordered table-hover no-footer" >
        ...
        <tbody>
        <?php if(is_array($cnews) || $cnews instanceof \think\Collection || $cnews instanceof \think\Paginator): $i = 0; $__LIST__ = $cnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
            <td  style="text-align: left" class="gai"><input class="textbtn"  type="text" style="border:none;width: 100%" readonly="readonly" value="<?php echo $vo['title']; ?>"></td>
            <td class="gai"><input class="textbtn"  type="text" style="border:none" readonly="readonly" value="<?php echo $vo['subtitle']; ?>" ></td>
            <td class="gai"><input class="textbtn"  type="text" style="border:none" readonly="readonly" value="<?php echo $vo['source']; ?>"></td>
            <td class="gai"><input class="textbtn"  type="text" style="border:none" readonly="readonly" value="<?php echo $vo['writer']; ?>"></td>
            <td class=""><input class="textbtn" type="text" style="border:none" readonly="readonly" value="<?php echo date('Y-m-d',$vo['time']); ?>"></td>
            <td class="gai" style="display: none"><input class="textbtn"  type="text" style="border:none;width: 100%" readonly="readonly" value="http://localhost/home/detail/index.html"></td>
            <td width="200">
                <a href="admin/content/edit?ac=newshangye&bc=gai&id=<?php echo $vo['Id']; ?>" class="btn btn-xs  btn-primary">查看/修改内容</a>
