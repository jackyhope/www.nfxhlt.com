<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/home/wwwroot/www.nfxhlt.com/public/../application/home/view/server/index.html";i:1537847649;s:69:"/home/wwwroot/www.nfxhlt.com/application/home/view/public/common.html";i:1538205152;s:69:"/home/wwwroot/www.nfxhlt.com/application/home/view/public/header.html";i:1536289120;s:69:"/home/wwwroot/www.nfxhlt.com/application/home/view/public/footer.html";i:1537324666;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--banner-->
<div class="banner" style="height: 26rem ;" >
    <img style="height: 26rem" src="../../<?php echo $list['banner']; ?>" alt="">
</div>
<!--banner-->
...
<div class="cot">
    <div class="five-cn">
        <div class="qk"></div>
        <div class="cn-text">
            <?php if(is_array($serverTitle) || $serverTitle instanceof \think\Collection || $serverTitle instanceof \think\Paginator): $i = 0; $__LIST__ = $serverTitle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['source'] == 'promiss1'): ?>
            <span><?php echo $vo['titlename']; ?></span>
            <span><?php echo $vo['subname']; ?>:<span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['titlecontent']; ?></span></span>
            <?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($serverTitle) || $serverTitle instanceof \think\Collection || $serverTitle instanceof \think\Paginator): $i = 0; $__LIST__ = $serverTitle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['source'] == 'promiss2'): ?>
            <span><?php echo $vo['subname']; ?>:<span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['titlecontent']; ?></span></span><?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($serverTitle) || $serverTitle instanceof \think\Collection || $serverTitle instanceof \think\Paginator): $i = 0; $__LIST__ = $serverTitle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['source'] == 'promiss3'): ?>
            <span style="letter-spacing: 0.395rem"><?php echo $vo['subname']; ?>:<span style="letter-spacing: 0px">&nbsp;&nbsp;&nbsp;<?php echo $vo['titlecontent']; ?></span></span><?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($serverTitle) || $serverTitle instanceof \think\Collection || $serverTitle instanceof \think\Paginator): $i = 0; $__LIST__ = $serverTitle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['source'] == 'promiss4'): ?>
            <span><?php echo $vo['subname']; ?>:<span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['titlecontent']; ?></span></span><?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($serverTitle) || $serverTitle instanceof \think\Collection || $serverTitle instanceof \think\Paginator): $i = 0; $__LIST__ = $serverTitle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['source'] == 'promiss5'): ?>
            <span><?php echo $vo['subname']; ?>:<span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['titlecontent']; ?></span></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
            <div>
                <input type="button" value="免费资讯">
                <span>服务热线：137-1876-7011</span>
            </div>
        </div>
    </div>
    <!-- 服务监督 -->
    <div class="supervision">
        ...
        <div class="line"></div>
        <div class="s-span">
            <span>如果您在以下环节遇到问题，</span>
            <span>除了直接跟猎头顾问进行沟通，</span>
            <span>还可以拨打投诉电话或发邮件反映情况，</span>
            <span>南方新华将为您提供全程放心服务。</span>
        </div>
        <table cellspacing="0" cellpadding="0" class="s-table">
            <tbody>
            <tr class="t-tr1">
                <th>编号</th>
                <th>服务要索</th>
            ...
            <?php if(is_array($serverTable) || $serverTable instanceof \think\Collection || $serverTable instanceof \think\Paginator): $i = 0; $__LIST__ = $serverTable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo $vo['number']; ?></td>
                <td><?php echo $vo['component']; ?></td>
