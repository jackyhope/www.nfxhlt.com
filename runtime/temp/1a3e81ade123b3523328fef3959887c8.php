<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/hunter/edit.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534243446;s:68:"/home/wwwroot/www.nfxhlt.com/application/admin/view/hunter/menu.html";i:1534243447;}*/ ?>
        ...
        <div class="userinfodrop">
            ...
            <div class="userdata" style="margin:0">
                <ul style="width: 100%;text-align: center">
                    <li><a href="#"><?php echo \think\Session::get('account'); ?></a></li>
...
<div class="centercontent">
    ...
    <div class="pageheader notab">
        <h1 class="pagetitle">猎头管理 <small></small></h1>
    </div>
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <form method="post" action="admin/hunter/modify" class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $list['Id']; ?>">
            <input type="hidden" name="url" value="<?php echo $list['urlposition']; ?>">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">英文名</label>
                <div class="col-md-9">
                    <input type="text" name="ename" class="form-control" placeholder="英文名" value="<?php echo $list['en']; ?>" required />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">猎头名</label>
                <div class="col-md-9">
                    <input type="text" name="cname" class="form-control" placeholder="请输入介绍" value="<?php echo $list['ch']; ?>" required />
                </div>
            </div>
            <div class="form-group">
