<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/hunter/add.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534243446;s:67:"/home/wwwroot/www.nfxhlt.com/application/admin/view/image/menu.html";i:1534243447;}*/ ?>
...
<div class="centercontent">
    ...
    <div class="pageheader notab">
        <h1 class="pagetitle">图片管理 <small>图片中心</small></h1>
    </div>
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <form method="post" action="admin/hunter/doadd" class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="ename" class="form-control" placeholder="请输入英文名..." value="" required />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">猎头名</label>
                <div class="col-md-9">
                    <input type="text" name="cname" class="form-control" placeholder="请输入中文名..." value="" required />
                </div>
            </div>
