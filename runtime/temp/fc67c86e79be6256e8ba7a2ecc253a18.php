<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/home/wwwroot/www.nfxhlt.com/public/../application/admin/view/image/imgcenter.html";i:1534243447;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/common.html";i:1534243446;s:70:"/home/wwwroot/www.nfxhlt.com/application/admin/view/common/header.html";i:1534843390;s:67:"/home/wwwroot/www.nfxhlt.com/application/admin/view/image/menu.html";i:1534243447;}*/ ?>
...
<div class="pageheader notab">
    <if condition='#'>
        ...
        <else/>
        <h1 class="pagetitle">图片中心 <small><a >添加</a></small></h1>
    </if>
</div>
...
<div id="contentwrapper" class="contentwrapper">
    ...
    <table class="table table-striped table-bordered table-hover no-footer" >
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td  style="text-align: left" class="gai"><input class="textbtn"  type="text" style="border:none" readonly="readonly" value="<?php echo $i; ?>"></td>
                    <td class="gai"><img src="/static<?php echo $vo['urlposition']; ?><?php echo $vo['name']; ?>" style="width: 243px" alt=""></td>
                    <td width="200">
                        <a href="admin/image/edit.html?id=<?php echo $vo['Id']; ?>" class="btn btn-xs  btn-primary xiugai">修改</a>
